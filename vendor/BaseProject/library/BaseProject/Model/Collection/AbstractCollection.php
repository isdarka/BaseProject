 ...
 *
 * @author isdarka
 * @created Aug 28, 2013 2:42:45 PM
 */
namespace BaseProject\Model\Collection;

use BaseProject\Model\Collection\Interfaces\InterfaceCollection;
use Zend\Json\Json;
use BaseProject\Model\Bean\AbstractBean;

abstract class AbstractCollection extends \ArrayIterator implements InterfaceCollection
{
